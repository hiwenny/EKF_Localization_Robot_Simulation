% Part1.m - version modified of DemoEKF.m 
...
% This part contains unused variables
% Why? I did part 1 and 2 in the same file and didn't make backup of part 1
% Hence I edited part 2 to show part 1 (only bearing).
